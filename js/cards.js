...
import { FORMATS, ELEMENTS, moitiesDe, plHalf, objLabel, tcTexte, teinteTc, seuilTexte, estRegleKind, cibleDe, objPortee, PORTEES, objsDe, teinteObj, transformeCadre } from './data.js?v=2.21';
import { elIcon, numIcon, cadrageIcon } from './icons.js?v=2.21';
import { urlVisuel } from './visuels.js?v=2.21';
