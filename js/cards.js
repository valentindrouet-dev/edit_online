...
import { FORMATS, ELEMENTS, moitiesDe, plHalf, objLabel, tcTexte, teinteTc, seuilTexte, estRegleKind, cibleDe, objPortee, PORTEES, objsDe, teinteObj, encreLibelle, transformeCadre } from './data.js?v=2.9';
import { elIcon, numIcon, cadrageIcon } from './icons.js?v=2.9';
import { urlVisuel } from './visuels.js?v=2.9';
