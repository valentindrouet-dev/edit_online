...
import { FORMATS, ELEMENTS, moitiesDe, plHalf, objLabel, tcTexte, objPortee, PORTEES, objsDe, teinteObj, encreLibelle } from './data.js?v=1.66';
import { elIcon, numIcon, cadrageIcon } from './icons.js?v=1.66';
