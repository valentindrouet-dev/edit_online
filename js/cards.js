...
import { FORMATS, ELEMENTS, moitiesDe, plHalf, objLabel, tcTexte, objPortee, PORTEES, objsDe, teinteObj } from './data.js?v=1.44';
import { elIcon, numIcon, cadrageIcon } from './icons.js?v=1.44';
