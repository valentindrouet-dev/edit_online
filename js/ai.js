...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart, limiteSequences } from './engine.js?v=2.18';
import { compter, bonusRegle, piocheOuverte } from './scoring.js?v=2.18';
import { PROFILS_IA } from './config.js?v=2.18';
