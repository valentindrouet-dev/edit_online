...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart, limiteSequences } from './engine.js?v=1.96';
import { compter, bonusRegle, piocheOuverte } from './scoring.js?v=1.96';
import { PROFILS_IA } from './config.js?v=1.96';
