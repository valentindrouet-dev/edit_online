...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart, limiteSequences } from './engine.js?v=2.3';
import { compter, bonusRegle, piocheOuverte } from './scoring.js?v=2.3';
import { PROFILS_IA } from './config.js?v=2.3';
