...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart, limiteSequences, limitePlans, ouverturesBanc } from './engine.js?v=2.26';
import {
...
import { objsDe, moitiesDe } from './data.js?v=2.26';
import { PROFILS_IA } from './config.js?v=2.26';
