...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart, limiteSequences } from './engine.js?v=1.88';
import { compter, bonusRegle, piocheOuverte } from './scoring.js?v=1.88';
import { PROFILS_IA } from './config.js?v=1.88';
