...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart } from './engine.js?v=1.39';
import { compter } from './scoring.js?v=1.39';
import { PROFILS_IA } from './config.js?v=1.39';
