...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart, limiteSequences } from './engine.js?v=1.91';
import { compter, bonusRegle, piocheOuverte } from './scoring.js?v=1.91';
import { PROFILS_IA } from './config.js?v=1.91';
