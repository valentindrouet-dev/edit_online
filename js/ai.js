...
import { coupsPossibles, appliquer, optionsDerushage, choixDepart, limiteSequences } from './engine.js?v=2.9';
import { compter, bonusRegle, piocheOuverte } from './scoring.js?v=2.9';
import { PROFILS_IA } from './config.js?v=2.9';
