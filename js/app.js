...
import { VERSION, BUILD_DATE, CHANGELOG } from './version.js?v=2.18';
import {
...
import { DEFAULTS, SCHEMA, PROFILS_IA, COULEURS_JOUEURS, PALETTE_JOUEURS, encreDe, cloneConfig, migrerCfg, MODES, modeCourant } from './config.js?v=2.18';
import { elIcon, numIcon } from './icons.js?v=2.18';
import { renderCarte, renderPlan, renderDos, enPile, tc, objHTML, objContenu, cadrageIcon, estSi, estRegle, reglerLectureNue } from './cards.js?v=2.18';
...
} from './engine.js?v=2.18';
import { choisirCoup, choisirDerushage, choisirDepart } from './ai.js?v=2.18';
import { compter, SOURCES_LABEL, estRaccord, objsEffectifs, raccordBonifie, compteIcone, compteCible, compteGroupes, bancVide } from './scoring.js?v=2.18';
import { releve, voler, stopperVols } from './anim.js?v=2.18';
import { campagne } from './lab.js?v=2.18';
import { archiveCartes, planchesCartes, PLANCHE } from './export-pdf.js?v=2.18';
import { CONTRAINTES, CONTRAINTES_PAR_DEFAUT, fautes, bilan, melangerMoities, repartition } from './melange.js?v=2.18';
import { Salon } from './net/salon.js?v=2.18';
import { TransportLocal } from './net/local.js?v=2.18';
import { TransportSupabase } from './net/supabase.js?v=2.18';
import { enLigneDisponible } from './net/config.js?v=2.18';
import { coupNu } from './net/protocole.js?v=2.18';
import { REGLES_VERSION, REGLES_HISTORIQUE, corpsRegles, corpsVersion } from './regles.js?v=2.18';
import { livret, aideDeJeu } from './livret.js?v=2.18';
